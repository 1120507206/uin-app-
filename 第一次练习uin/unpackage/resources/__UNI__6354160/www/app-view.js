...
__wxAppCode__['pages/index/index.wxss']=setCssToHead([".",[1],"uni-media-list-logo{ height: 50px; width: 50px; }\n",],undefined,{path:"./pages/index/index.wxss"});    
__wxAppCode__['pages/index/index.wxml']=$gwx('./pages/index/index.wxml');

__wxAppCode__['pages/info/info.wxss']=setCssToHead([".",[1],"content{ padding: ",[0,10]," 2%; width: 96%; -webkit-flex-wrap: wrap; flex-wrap: wrap; }\n.",[1],"title{ line-height: 2em; font-weight: 700; font-size: ",[0,40],"; }\n.",[1],"act-content{ line-height: 2em; }\n",],undefined,{path:"./pages/info/info.wxss"});    
